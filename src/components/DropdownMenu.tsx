...
const isAuthenticatedInitially = !!authTokenLocalStorage || !!authTokenSessionStorage;


const DropdownTriggerMenu: React.FC = () => {
  const navigate = useNavigate();
  const [isAuthenticated, setIsAuthenticated] = useState(isAuthenticatedInitially);
